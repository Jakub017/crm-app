...
<form class="form-wrapper__form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
    ...
    <div class="form-wrapper__input-group">
        ...
        <input class="form-wrapper__input" id="name" type="text" name="name" :value="old('name')" required autofocus
            autocomplete="name" placeholder="Imię" />
    ...
    <div class="form-wrapper__input-group">
        ...
        <input class="form-wrapper__input" id="email" class="block mt-1 w-full" type="email" name="email"
            :value="old('email')" required autocomplete="email" placeholder="Adres email" />
    ...
    <div class="form-wrapper__input-group">
        ...
        <input class="form-wrapper__input" id="password" class="block mt-1 w-full" type="password" name="password"
            required autocomplete="new-password" placeholder="Hasło" />
    ...
    <div class="form-wrapper__input-group">
        ...
        <input class="form-wrapper__input" id="password_confirmation" class="block mt-1 w-full" type="password"
    ...
    <p class="form-wrapper__login-link">Masz już konto? <a href="{{route('login')}}">Zaloguj się!</a></p>
